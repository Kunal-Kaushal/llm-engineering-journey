...
| 3 | Open-Source Gen AI — Automated Solutions with HuggingFace | Done |
| 4 | LLM Showdown — Evaluating Models for Code Gen & Business Tasks | Done |
...
**Focus:** Running LLMs locally, HuggingFace Hub, Diffusers, AutoTokenizer, and audio processing pipelines

| Day | Notebook | What I built |
|-----|----------|-------------|
| 1 | `day1.ipynb` | Image generation pipeline using Diffusers and audio transcription using HuggingFace models |
| 2 | `day2.ipynb` | Named Entity Recognition (NER) pipeline and further HuggingFace experiments |
| 3 | `day3.ipynb` | Tokenizer exploration and causal language modeling with open-source models |
| 4 | `day4.ipynb` | Running LLMs with custom tokenizers and BitAndBytes configurations for optimization |
| 5 | `day5.ipynb` | Meeting minutes generator tool from audio transcripts using open and closed-source models |

---

## Week 4 — LLM Evaluation for Code Gen & Business Tasks

**Focus:** Model benchmarking, code translation (Python to C++/Rust), and integrating system commands with LLMs

| Day/File | What I built |
|----------|-------------|
| `day3.ipynb` | Tool using LLMs to interact with system subroutines and translate logic |
| `day5.ipynb` | AI-assisted code porting application (Python to C++/Rust) with a Gradio UI |
| `system_info.py` | Helper script to fetch system architecture and compiler details |
| `styles1.py` | Custom CSS styling for the Gradio interface |
| `main.cpp`/`main.rs` | Optimized code equivalents generated by the LLM |
